...
function categorizeTransaction(description) {
  ...
  if (descLower.includes('tarjeta credito') || descLower.includes('tarjeta crédito') ||
      descLower.includes('tarjeta credito') || descLower.includes('tarjeta de credito') ||
      descLower.includes('tarjeta de crédito') || descLower.includes('pago tarjeta') ||
      descLower.includes('liquidacion tarjeta') || descLower.includes('liquidación tarjeta') ||
      descLower.includes('cargo tarjeta') || descLower.includes('pago visa') ||
      descLower.includes('pago mastercard') || descLower.includes('pago american express') ||
      descLower.includes('pago amex') || descLower.includes('credit card payment') ||
      descLower.includes('pago tarjeta credito') || descLower.includes('pago tarjeta crédito') ||
