  ...
  return (
    <>
      ...
      <div className="hidden md:block w-full">
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-premium p-2 flex flex-wrap gap-2 justify-start items-center border border-gray-100/50 dark:border-gray-700/50 animate-fadeIn w-full overflow-x-auto" role="tablist" style={{ minWidth: '100%' }}>
          {tabs.map((tab) => {
