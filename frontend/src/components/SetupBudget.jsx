    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
        ...
        {userProfile && userProfile.monthlyIncome && (() => {
          // Calculate Budget Usage using ONLY monthly budgets (exclude annual)
          const monthlyBudgetsTotal = Object.entries(budgets)
            .filter(([catName]) => !isAnnual[catName])
            .reduce((sum, [, budget]) => sum + (budget || 0), 0);
          const budgetUsagePercentage = (monthlyBudgetsTotal / userProfile.monthlyIncome) * 100;
            ...
            <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="mt-2">
                <div className="flex items-center justify-between mb-1">
                  <span className="text-xs text-gray-500 dark:text-gray-400">Budget Usage (Monthly only)</span>
